...
"Day": ["CARTRADE","ACMESOLAR","AGIIL","ALICON","BLUESTARCO","SWIGGY","INDIAMART","ASTERDM","CRIZAC"],
  ...
  "Finance": [
    ...
    "KFINTECH.NS", "CAMS.NS", "MASFIN.NS", "TRIDENT.NS", "SBFC.NS",
  ...
  "Chemicals": [
    ...
    "SUMICHEM.NS", "PIIND.NS", "EIDPARRY.NS", "CHEMPLASTS.NS",
  ...
  "Infrastructure": [
    ...
    "IRCON.NS", "ENGINERSIN.NS", "AHLUCONT.NS", "PSPPROJECTS.NS", "CAPACITE.NS",
  ...
  "Construction Materials": [
    ...
    "HEIDELBERG.NS", "INDIACEM.NS", "PRSMJOHNSN.NS", "STARCEMENT.NS", "SAGCEM.NS",
